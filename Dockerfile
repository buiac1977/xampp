...
RUN wget https://www.apachefriends.org/xampp-files/7.1.10/xampp-linux-x64-7.1.10-0-installer.run
RUN chmod +x xampp-linux-x64-7.1.10-0-installer.run
RUN bash -c './xampp-linux-x64-7.1.10-0-installer.run'
